...
- **Rennmodus**: Qualifikation, F1-Startampel, **5 Runden** mit Rundenzähler und Platzierung; **4 KI-Gegner** (Feld also 5 Autos) mit gleicher Beschleunigung & gleichem Kurven-Grip wie der Spieler, die einander überholen und sich nicht überlappen. Die KI **sieht den Spieler als Hindernis**: sie reiht sich hinter ihm ein statt ihn zu schieben und schert zum Überholen früh und weit genug aus. Der nötige Abstand wächst dabei mit der Annäherungsgeschwindigkeit (Puffer + Bremsweg) – ein fester Wert reicht nicht, weil der Einschlag sonst schon unvermeidbar ist, wenn der Bot zu bremsen anfängt
